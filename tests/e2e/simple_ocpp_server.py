...
class SimpleOCPPServer:
                ...
                try:
                    ...
                    if len(data) >= 4 and data[0] == 2:  # OCPP 2.0.1 CALL
                        ...
                        if action == "BootNotification":
                            station_id = payload.get("chargingStation", {}).get(
    ...
    async def send_response(
        self, websocket: WebSocketServerProtocol, message_id: str, action: str, response: dict
    ):
        """Send OCPP response."""
    ...
    async def send_error(
        self, websocket: WebSocketServerProtocol, message_id: str, action: str, error_code: str
    ):
        """Send OCPP error."""
    ...
    async def handle_boot_notification(self, payload: dict) -> dict:
        ...
        return {"status": "Accepted", "currentTime": "2023-01-01T00:00:00Z", "interval": 300}

    async def handle_heartbeat(self, payload: dict) -> dict:
        """Handle Heartbeat."""
        return {"currentTime": "2023-01-01T00:00:00Z"}
    ...
    async def handle_request_start_transaction(self, payload: dict) -> dict:
        ...
        return {"status": "Accepted", "transactionId": "TXN123456"}
    ...
    async def handle_get_variables(self, payload: dict) -> dict:
        ...
        return {"status": "Accepted", "getVariableResult": get_variable_result}
    ...
    async def handle_set_variables(self, payload: dict) -> dict:
        ...
        return {"status": "Accepted", "setVariableResult": set_variable_result}
    ...
    async def handle_get_charging_profiles(self, payload: dict) -> dict:
        ...
        return {"status": "Accepted", "chargingProfile": []}
    ...
    async def handle_get_monitoring_report(self, payload: dict) -> dict:
        ...
        return {
            "status": "Accepted",
            "monitoringReport": {"id": "REPORT_001", "monitoringData": []},
        }
