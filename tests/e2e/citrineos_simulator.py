...
class CitrineOSSimulator:
    ...
    async def status_notification(self, connector_id: int, status: str, error_code: str = "NoError") -> Dict[str, Any]:
    ...
    async def meter_values(self, evse_id: int, energy: float, transaction_id: Optional[str] = None) -> Dict[str, Any]:
        """Send MeterValues."""
        payload = {
            "evseId": evse_id,
            "meterValue": [{
    ...
    async def transaction_event(self, event_type: str, transaction_id: str, trigger_reason: str = "Authorized") -> Dict[str, Any]:
    ...
    async def request_start_transaction(self, evse_id: int, id_token: str = "AUTH123") -> Dict[str, Any]:
    ...
    async def set_variables(self, component_name: str, variable_name: str, value: str) -> Dict[str, Any]:
        """Send SetVariables."""
        payload = {
            "setVariableData": [{
                "component": {
    ...
    async def set_charging_profile(self, evse_id: int, profile_id: int, limit: float) -> Dict[str, Any]:
    ...
    async def trigger_message(self, requested_message: str, evse_id: Optional[int] = None) -> Dict[str, Any]:
        """Send TriggerMessage."""
        payload = {
    ...
    async def set_display_message(self, message_id: int, message: str) -> Dict[str, Any]:
        ...
        payload = {
            "message": {
                ...
                "endDateTime": (datetime.now(timezone.utc).replace(hour=23, minute=59, second=59)).isoformat(),
                "message": {
                    "format": "UTF8",
                    "language": "en",
                    "content": message
