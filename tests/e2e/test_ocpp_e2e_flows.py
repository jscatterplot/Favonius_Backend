...
from src.websocket_handler.config import Config, TLSConfig, WebSocketConfig, TimescaleConfig, SupabaseConfig
...
class TestOCPPEndToEndFlows:
    ...
    async def test_complete_charging_session_flow(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_error_recovery_flow(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_concurrent_sessions_flow(self, config, timescale_client, connection_manager, message_handler):
        ...
        for i, station_id in enumerate(stations):
            transaction_payload = {
                ...
                "seqNo": 1,
                "transactionInfo": {
                    "transactionId": f"TXN_{station_id}_{i}"
                },
                "evse": {"id": 1},
                "idToken": {
                    "idToken": f"RFID_{station_id}",
                    "type": "ISO14443"
                }
            }
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_heartbeat_monitoring_flow(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_data_persistence_flow(self, config, timescale_client, connection_manager, message_handler):
...
class TestOCPPProtocolCompliance:
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_ocpp_message_format_compliance(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_ocpp_error_handling_compliance(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_ocpp_timestamp_compliance(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_ocpp_measurand_compliance(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_ocpp_unit_compliance(self, config, timescale_client, connection_manager, message_handler):
...
class TestOCPPPerformanceE2E:
    ...
    async def test_high_throughput_message_processing(self, config, timescale_client, connection_manager, message_handler):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(120)
    async def test_concurrent_station_processing(self, config, timescale_client, connection_manager, message_handler):
