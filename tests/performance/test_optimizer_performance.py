...
def test_cold_start_benchmark_20_vehicles(benchmark_depot_state, benchmark_depot_config):
...
@pytest.mark.slow
@pytest.mark.performance
def test_warm_start_benchmark_20_vehicles(benchmark_depot_state, benchmark_depot_config):
    """Benchmark warm-start solve time for 20 vehicles."""
    # Cold-start first
    cold_result = optimize(benchmark_depot_state, benchmark_depot_config, time_limit=60.0)
...
@pytest.mark.slow
@pytest.mark.performance
def test_optimization_techniques_combined(benchmark_depot_state, benchmark_depot_config):
...
@pytest.mark.slow
@pytest.mark.performance
def test_performance_metrics_logging(benchmark_depot_state, benchmark_depot_config):
