...
class TestRunner:
    ...
    async def run_citrineos_single_station_test(self):
        ...
        try:
            ...
            if start_result[2].get("status") == "Accepted":
                ...
                end_result = await station.transaction_event(
            ...
            self.test_results["citrineos_single_station"] = {"success": False, "error": str(e)}
            return False
    ...
    async def run_citrineos_fleet_test(self):
        ...
        try:
            ...
            self.test_results["citrineos_fleet"] = {"success": False, "error": str(e)}
            return False
    ...
    async def run_end_to_end_tests(self):
        ...
        try:
            ...
            self.test_results["end_to_end_tests"] = {"success": False, "error": str(e)}
            return False
        finally:
            # Cleanup CitrineOS
