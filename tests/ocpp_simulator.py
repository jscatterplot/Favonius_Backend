...
class OCPPSimulator:
    ...
    async def status_notification(
        self, connector_id: int = 1, status: str = "Available"
    ) -> Dict[str, Any]:
    ...
    async def get_variables(self, variables: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Send GetVariables."""
        message = {"action": "GetVariables", "payload": {"getVariableData": variables}}
        return await self.send_message(message)

    async def set_variables(self, variables: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Send SetVariables."""
        message = {"action": "SetVariables", "payload": {"setVariableData": variables}}
        return await self.send_message(message)
    ...
    async def clear_charging_profile(self, profile_id: Optional[int] = None) -> Dict[str, Any]:
        ...
        message = {"action": "ClearChargingProfile", "payload": payload}
        return await self.send_message(message)

    async def get_composite_schedule(
        self, evse_id: int = 1, duration: int = 3600
    ) -> Dict[str, Any]:
    ...
    async def request_start_transaction(
        self, evse_id: int = 1, id_token: str = "test_token"
    ) -> Dict[str, Any]:
        """Send RequestStartTransaction."""
        message = {
            "action": "RequestStartTransaction",
            "payload": {"evseId": evse_id, "idToken": {"idToken": id_token, "type": "ISO14443"}},
        }
        return await self.send_message(message)
    ...
    async def request_stop_transaction(self, transaction_id: str) -> Dict[str, Any]:
        ...
        message = {
            ...
            "payload": {"transactionId": transaction_id, "reason": "Remote"},
        }
        return await self.send_message(message)

    async def reset(self, reset_type: str = "Immediate") -> Dict[str, Any]:
        """Send Reset."""
        message = {"action": "Reset", "payload": {"type": reset_type}}
        return await self.send_message(message)
    ...
    async def change_availability(self, operational_status: str = "Operative") -> Dict[str, Any]:
        ...
        message = {
            ...
            "payload": {"operationalStatus": operational_status, "evse": {"id": 1}},
        }
        return await self.send_message(message)
    ...
    async def trigger_message(
        ...
        message = {
            ...
            "payload": {"requestedMessage": requested_message, "evse": {"id": 1}},
        }
        return await self.send_message(message)
    ...
    async def get_15118_ev_certificate(
        self, certificate_type: str = "V2GRootCertificate"
    ) -> Dict[str, Any]:
    ...
    async def install_certificate(
        self, certificate_type: str = "V2GRootCertificate", certificate: str = "test_cert"
    ) -> Dict[str, Any]:
