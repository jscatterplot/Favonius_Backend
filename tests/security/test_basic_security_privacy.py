...
from websocket_handler.security_manager import SecurityManager, SecurityConfig, SecurityProfile
...
class TestBasicSecurityPrivacy:
    ...
    async def test_basic_encryption(self, security_manager):
        ...
        try:
            ...
            assert "encrypt" in str(e).lower() or "crypto" in str(e).lower() or "key" in str(e).lower()
    ...
    async def test_basic_privacy_operations(self, privacy_manager):
        ...
        try:
            ...
            assert "privacy" in str(e).lower() or "anonymize" in str(e).lower() or "data" in str(e).lower()
    ...
    async def test_certificate_operations(self, certificate_manager):
        ...
        try:
            ...
            assert "certificate" in str(e).lower() or "cert" in str(e).lower() or "x509" in str(e).lower()
