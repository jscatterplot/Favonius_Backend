...
from src.websocket_handler.main import Application
...
from src.websocket_handler.v2x_controller import V2XController, V2XSetpoint, V2XOperationMode
...
class TestCrossModuleIntegration:
    ...
    async def health_server(self):
        ...
        server.metrics_collector.get_summary_stats = AsyncMock(return_value={"total_connections": 5})
        return server
    
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_websocket_server_integration(self, config, mock_timescale_client, connection_manager, message_handler):
        ...
        await connection_manager.register_connection("TEST_STATION_001", "conn_001", "192.168.1.100", mock_websocket)
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_v2x_controller_integration(self, config, mock_timescale_client, v2x_controller, connection_manager):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_der_control_integration(self, config, mock_timescale_client, der_control_manager, v2x_controller):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_analytics_integration(self, config, mock_timescale_client, analytics_service, telemetry_service):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_data_sync_integration(self, config, mock_timescale_client, mock_supabase_client, data_sync_service, analytics_service):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_api_server_integration(self, config, mock_supabase_client, api_server, analytics_service):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_health_monitoring_integration(self, config, health_server, connection_manager, analytics_service):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(60)
    async def test_complete_system_integration(self, config, mock_timescale_client, mock_supabase_client, 
                                             connection_manager, message_handler, v2x_controller, 
                                             der_control_manager, analytics_service, data_sync_service, 
                                             telemetry_service, api_server, health_server):
...
class TestModuleErrorHandling:
    ...
    async def config(self):
        ...
        return Config(
            ...
            tls={}, monitoring={}, price_feeder={}, v2x_controller={}
        )
