...
from src.core.optimizer.exceptions import InfeasibleModelError, SolverError
...
class TestOptimizerEdgeCases:
    ...
    def test_fallback_logging(self, depot_config):
        ...
        with patch('src.core.optimizer.solver.logger') as mock_logger:
            result = optimize(state, depot_config, time_limit=30.0)
