...
class TestTriggerToOptimizationFlow:
    ...
    @pytest.mark.asyncio
    async def test_soc_deviation_trigger_optimization(
    ...
    @pytest.mark.asyncio
    async def test_price_change_trigger_optimization_or_logic(
        self, depot_config, depot_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_return_time_deviation_trigger_optimization(
        self, depot_config, depot_state
    ):
    ...
    async def test_scheduled_trigger_optimization(self):
        ...
        should_trigger = (
            7 <= current_hour <= 23
            and monitor._last_scheduled_hour != current_hour
        )
...
class TestTriggerCooldown:
    ...
    async def test_different_cooldown_values_work(self):
        ...
        monitor_1min = TriggerMonitor(
            config_1min, AsyncMock(), assembler=MagicMock()
        )
        ...
        monitor_10min = TriggerMonitor(
            config_10min, AsyncMock(), assembler=MagicMock()
        )
