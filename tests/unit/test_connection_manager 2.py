...
class TestConnectionManager:
    ...
    async def test_register_connection(self, connection_manager, mock_websocket):
        ...
        await connection_manager.register_connection(station_id, connection_id, client_ip, mock_websocket)
    ...
    async def test_cleanup_stale_connections(self, connection_manager):
        ...
        # Register connection
        await connection_manager.register_connection(station_id, connection_id, "127.0.0.1", mock_ws)
    ...
    async def test_connection_limit_enforcement(self, connection_manager):
        ...
        await connection_manager.register_connection("EXTRA_STATION", "extra_conn", "127.0.0.1", extra_ws)
