...
from websocket_handler.monitoring import (
    setup_monitoring, setup_logging, get_logger, MetricsCollector,
    PerformanceTimer, timer, async_timer, HealthChecker, setup_health_checks
)
...
class TestPerformanceTimer:
    ...
    def test_performance_timer_context_manager(self):
        ...
        with PerformanceTimer("test_operation", callback) as timer:
...
class TestSetupHealthChecks:
    ...
    def test_setup_health_checks_with_connection_manager(self, mock_health_checker):
        ...
        assert connections_call[1]["critical"] == True
    ...
    def test_setup_health_checks_with_timescale_client(self, mock_health_checker):
        ...
        assert timescale_call[1]["critical"] == True
    ...
    def test_setup_health_checks_system_check(self, mock_health_checker):
        ...
        with patch('psutil.cpu_percent', return_value=50), \
            ...
            assert call_args[1]["critical"] == False
