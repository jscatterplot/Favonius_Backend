...
class TestStartAllControllers:
    ...
    @pytest.mark.asyncio
    async def test_start_all_controllers_already_running(self, mock_db_pool, controller_config):
...
class TestAddController:
    ...
    @pytest.mark.asyncio
    async def test_add_controller_creates_new(self, mock_db_pool, controller_config, depot_config):
        ...
        with patch(
            "src.core.controller_manager.StateAssembler.load_depot_config", new_callable=AsyncMock
        ) as mock_load:
    ...
    @pytest.mark.asyncio
    async def test_add_controller_returns_existing(self, mock_db_pool, controller_config):
    ...
    @pytest.mark.asyncio
    async def test_add_controller_with_uuid(self, mock_db_pool, controller_config, depot_config):
    ...
    @pytest.mark.asyncio
    async def test_add_controller_raises_on_config_error(self, mock_db_pool, controller_config):
...
class TestRemoveController:
    ...
    @pytest.mark.asyncio
    async def test_remove_controller_stops_and_removes(self, mock_db_pool, controller_config):
    ...
    @pytest.mark.asyncio
    async def test_remove_controller_cancels_task(self, mock_db_pool, controller_config):
    ...
    @pytest.mark.asyncio
    async def test_remove_controller_not_found(self, mock_db_pool, controller_config):
...
class TestGetOrCreateController:
    ...
    @pytest.mark.asyncio
    async def test_get_or_create_returns_existing(self, mock_db_pool, controller_config):
    ...
    @pytest.mark.asyncio
    async def test_get_or_create_creates_new(self, mock_db_pool, controller_config, depot_config):
...
class TestHealthCheck:
    ...
    @pytest.mark.asyncio
    async def test_health_check_healthy_controller(self, mock_db_pool, controller_config):
    ...
    @pytest.mark.asyncio
    async def test_health_check_degraded_controller(self, mock_db_pool, controller_config):
    ...
    @pytest.mark.asyncio
    async def test_health_check_error_handling(self, mock_db_pool, controller_config):
