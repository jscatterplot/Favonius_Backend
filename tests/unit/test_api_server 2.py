...
class TestAPIServer:
    ...
    async def test_get_active_sessions(self, api_server, mock_supabase_client):
        ...
        mock_supabase_client.get_active_sessions = AsyncMock(return_value=[
            {'id': 'session1', 'vehicle_id': 'vehicle1', 'status': 'active'},
    ...
    async def test_stop_session(self, api_server, mock_supabase_client):
        ...
        mock_supabase_client.update_session_status = AsyncMock(return_value={'id': 'session1', 'status': 'stopped'})
    ...
    async def test_get_schedules(self, api_server, mock_supabase_client):
        ...
        mock_supabase_client.get_schedule_configs = AsyncMock(return_value=[
    ...
    async def test_create_schedule(self, api_server, mock_supabase_client):
        ...
        mock_supabase_client.create_schedule_config = AsyncMock(return_value={'id': 'schedule123', 'vehicle_id': 'vehicle1', 'enabled': True})
    ...
    async def test_get_savings_analytics(self, api_server, mock_supabase_client):
        ...
        mock_supabase_client.calculate_savings = AsyncMock(return_value=[
