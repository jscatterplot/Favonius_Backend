...
class TestConnectionMonitorMinimal:
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_check_timescale_connection_success(
        self, connection_monitor, mock_timescale_client
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_check_timescale_connection_failure(
        self, connection_monitor, mock_timescale_client
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.timeout(30)
    async def test_check_supabase_connection_success(
        self, connection_monitor, mock_supabase_client
    ):
