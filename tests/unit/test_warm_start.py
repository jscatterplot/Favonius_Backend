...
class TestWarmStartPartialSolution:
    ...
    def test_warm_start_with_new_vehicle_added(self, simple_config):
...
class TestWarmStartInvalidValues:
    ...
    def test_warm_start_clamps_soc_above_bounds(self, mock_model, simple_state, simple_config):
    ...
    def test_warm_start_clamps_soc_below_bounds(self, mock_model, simple_state, simple_config):
    ...
    def test_warm_start_clamps_battery_power(self, mock_model, simple_state, simple_config):
    ...
    def test_warm_start_handles_negative_grid_power(self, mock_model, simple_state, simple_config):
    ...
    def test_warm_start_handles_negative_peak_demand(self, mock_model, simple_state, simple_config):
...
class TestWarmStartMismatchedVehicles:
    ...
    def test_warm_start_with_removed_vehicle(self, simple_config):
...
class TestWarmStartDifferentHorizon:
    ...
    def test_warm_start_shorter_previous_horizon(self, mock_model, simple_state, simple_config):
...
class TestWarmStartEdgeCases:
    ...
    def test_warm_start_empty_schedule(self, mock_model, simple_state, simple_config):
