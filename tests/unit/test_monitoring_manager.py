...
from websocket_handler.monitoring_manager import MonitoringManager, MonitoringCriterion, AlertSeverity
...
class TestMonitoringManager:
    ...
    @pytest.mark.asyncio
    async def test_get_monitoring_report_configuration(self, monitoring_manager, mock_timescale_client):
    ...
    @pytest.mark.asyncio
    async def test_get_monitoring_report_operational(self, monitoring_manager, mock_timescale_client):
        """Test GetMonitoringReport for operational data."""
        result = await monitoring_manager.get_monitoring_report(
            station_id="TEST_STATION",
            request_id=1,
            monitoring_base="Operational"
        )
    ...
    @pytest.mark.asyncio
    async def test_set_variable_monitoring_threshold(self, monitoring_manager, mock_timescale_client):
    ...
    @pytest.mark.asyncio
    async def test_set_variable_monitoring_periodic(self, monitoring_manager, mock_timescale_client):
    ...
    @pytest.mark.asyncio
    async def test_check_monitoring_rules_threshold(self, monitoring_manager, mock_timescale_client):
    ...
    async def test_check_monitoring_rules_delta(self, monitoring_manager, mock_timescale_client):
        ...
        mock_timescale_client.get_periodic_monitoring_data.return_value = [
            {
                "value": "15.0"
            }
        ]
    ...
    @pytest.mark.asyncio
    async def test_check_monitoring_rules_no_trigger(self, monitoring_manager, mock_timescale_client):
    ...
    @pytest.mark.asyncio
    async def test_check_monitoring_rules_existing_alert(self, monitoring_manager, mock_timescale_client):
    ...
    async def test_monitoring_loop_error_handling(self, monitoring_manager):
        ...
        with patch.object(monitoring_manager, '_check_monitoring_rules', side_effect=Exception("Test error")):
    ...
    @pytest.mark.asyncio
    async def test_get_monitoring_data_error_handling(self, monitoring_manager, mock_timescale_client):
    ...
    @pytest.mark.asyncio
    async def test_set_variable_monitoring_error_handling(self, monitoring_manager, mock_timescale_client):
