...
class TestTimescaleClient:
    ...
    async def test_connect(self, timescale_client):
        ...
        with patch.object(timescale_client, '_establish_connections', new_callable=AsyncMock) as mock_establish, \
             patch.object(timescale_client, '_verify_timescale_extension', new_callable=AsyncMock) as mock_verify, \
             patch.object(timescale_client, '_test_connections', new_callable=AsyncMock) as mock_test:
