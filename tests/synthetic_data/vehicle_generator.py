...
class RouteGenerator:
    ...
    def generate_daily_routes(
        self, vehicles: List[VehicleProfile], date: datetime, routes_per_vehicle: int = 2
    ) -> List[RouteProfile]:
    ...
    def _generate_vehicle_routes(
        self, vehicle: VehicleProfile, date: datetime, num_routes: int
    ) -> List[RouteProfile]:
...
class SyntheticDataManager:
    ...
    def __init__(self, timescale_client, seed: int = 42):
        ...
        self.logger = get_logger(__name__)  # noqa: F821

    async def generate_and_store_fleet(
        self, fleet_size: int = 50, station_id: str = "default_station"
    ) -> List[VehicleProfile]:
    ...
    async def generate_test_scenario(
        self, fleet_size: int = 20, station_id: str = "test_station", date: datetime = None
    ) -> Dict[str, Any]:
