...
| Variable | Default | Description |
|---|---|---|
| `DATA_SOURCES_ENABLED` | `false` | Master flag. Mounts the router and starts the scheduler + startup recovery. |
