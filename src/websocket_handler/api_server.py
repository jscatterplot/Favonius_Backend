...
from .auth_manager import AuthManager, require_auth, require_permission, require_role, RateLimiter
...
class APIServer:
    ...
    def __init__(self, config: SupabaseConfig, supabase_client: SupabaseClient, auth_manager: AuthManager):
    ...
    async def get_vehicle(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            vehicles = await self.supabase_client.get_vehicles_by_organization(user['organization_id'])
    ...
    async def update_vehicle(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            vehicle = await self.supabase_client.update_vehicle_status(vehicle_id, data.get('status', 'active'))
            return web.json_response({'vehicle': vehicle})
        except Exception as e:
    ...
    async def get_stations(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            sites_response = self.supabase_client.client.table('sites').select('id').eq('organization_id', user['organization_id']).execute()
            ...
            stations_response = self.supabase_client.client.table('charging_stations').select('*').in_('site_id', site_ids).execute()
    ...
    async def get_station(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            station_response = self.supabase_client.client.table('charging_stations').select('*').eq('id', station_id).execute()
    ...
    async def update_station(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            station = await self.supabase_client.update_station_status(station_id, data.get('status', 'operational'))
    ...
    async def get_sessions(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            query = self.supabase_client.client.table('charging_sessions_summary').select('*').eq('organization_id', org_id)
    ...
    async def update_schedule(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            schedule_response = self.supabase_client.client.table('charging_schedules_config').update(data).eq('id', schedule_id).execute()
            return web.json_response({'schedule': schedule_response.data[0] if schedule_response.data else {}})
        except Exception as e:
    ...
    async def delete_schedule(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            self.supabase_client.client.table('charging_schedules_config').delete().eq('id', schedule_id).execute()
    ...
    async def get_energy_analytics(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            org_id = user['organization_id']
            start_date = request.query.get('start_date', (datetime.now(timezone.utc) - timedelta(days=30)).isoformat())
            end_date = request.query.get('end_date', datetime.now(timezone.utc).isoformat())
            
            analytics = await self.supabase_client.get_daily_energy_summary(org_id, start_date, end_date)
    ...
    async def get_cost_analytics(self, request: web.Request, user: Dict[str, Any]) -> web.Response:
        ...
        try:
            ...
            response = self.supabase_client.client.table('charging_sessions_summary').select(
                'start_time, cost_total, revenue_v2g'
            ).eq('organization_id', org_id).gte('start_time', start_date).lte('start_time', end_date).execute()
