...
class ResilienceManager:
    ...
    def add_circuit_breaker(
        self, service_name: str, failure_threshold: int = 5, recovery_timeout: float = 60.0
    ) -> None:
    ...
    async def execute_in_bulkhead(
        self, bulkhead_name: str, operation: Callable, *args, **kwargs
    ) -> Any:
        ...
        try:
            self.bulkhead_tasks[bulkhead_name] = asyncio.create_task(operation(*args, **kwargs))
