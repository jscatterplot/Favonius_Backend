...
class DeviceModel:
    ...
    def __init__(
        ...
        self.cache_manager = cache_manager or CacheManager(
            max_size=2000, default_ttl=timedelta(seconds=300)
        )
    ...
    def _initialize_standard_variables(self) -> None:
        ...
        self._add_standard_variable(
            "ChargingStation", "VendorName", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SerialNumber", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "FirmwareVersion", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable("ChargingStation", "Modem", VariableType.STRING, "ReadOnly")
        self._add_standard_variable(
            "ChargingStation", "SupportedFeatures", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedProtocols", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation",
        ...
        self._add_standard_variable(
            "ChargingStation", "SupportedChargingProfileTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedMeasurands", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedCableTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedConnectorTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedDisplayMessageTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedIdTokenTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedMessageTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedOcppVersions", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedReservationTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedSecurityProfiles", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedUnitTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedV2GModes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "SupportedV2XChargingCtrlrTypes", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable(
            "ChargingStation", "HeartbeatInterval", VariableType.INTEGER, "ReadWrite"
        )

        # EVSE variables
        self._add_standard_variable("EVSE", "AvailabilityState", VariableType.ENUM, "ReadWrite")
        self._add_standard_variable(
            "EVSE", "AvailabilitySchedule", VariableType.STRING, "ReadWrite"
        )
        ...
        # Connector variables
        self._add_standard_variable(
            "Connector", "AvailabilityState", VariableType.ENUM, "ReadWrite"
        )
        self._add_standard_variable(
            "Connector", "AvailabilitySchedule", VariableType.STRING, "ReadWrite"
        )
        ...
        self._add_standard_variable(
            "Connector", "ConnectorTypeId", VariableType.INTEGER, "ReadOnly"
        )
        ...
        self._add_standard_variable(
            "SmartCharging", "ChargingProfileMaxStackLevel", VariableType.INTEGER, "ReadOnly"
        )
        self._add_standard_variable(
            "SmartCharging",
        ...
        self._add_standard_variable(
            "SmartCharging", "ChargingScheduleMaxPeriods", VariableType.INTEGER, "ReadOnly"
        )
        self._add_standard_variable(
            "SmartCharging", "ConnectorSwitch3to1PhaseSupported", VariableType.BOOLEAN, "ReadOnly"
        )
        self._add_standard_variable(
            "SmartCharging", "MaxChargingProfilesInstalled", VariableType.INTEGER, "ReadOnly"
        )
        self._add_standard_variable(
            "SmartCharging", "MaxScheduledChargingProfiles", VariableType.INTEGER, "ReadOnly"
        )
        self._add_standard_variable(
            "SmartCharging", "MaxScheduledChargingProfilesPerEVSE", VariableType.INTEGER, "ReadOnly"
        )
        self._add_standard_variable(
            "SmartCharging",
            "MaxScheduledChargingProfilesPerEVSEConnector",
        ...
        self._add_standard_variable(
            "V2XController", "SupportedOperationModes", VariableType.STRING, "ReadOnly"
        )

        # Monitoring variables
        self._add_standard_variable(
            "Monitoring", "HeartbeatInterval", VariableType.INTEGER, "ReadWrite"
        )
        self._add_standard_variable(
            "Monitoring", "ClockAlignedDataInterval", VariableType.INTEGER, "ReadWrite"
        )

        # Security variables
        self._add_standard_variable(
            "Security", "AdditionalRootCertificateCheck", VariableType.BOOLEAN, "ReadWrite"
        )
        self._add_standard_variable(
            "Security", "CertificateSignedMaxChainSize", VariableType.INTEGER, "ReadOnly"
        )
        self._add_standard_variable(
            "Security", "CertificateStoreMaxLength", VariableType.INTEGER, "ReadOnly"
        )
        ...
        self._add_standard_variable(
            "Security", "SupportedFileTransferProtocols", VariableType.STRING, "ReadOnly"
        )
        self._add_standard_variable("Security", "TlsCipherSuite", VariableType.STRING, "ReadWrite")

    def _add_standard_variable(
        self, component: str, name: str, var_type: VariableType, mutability: str
    ) -> None:
        ...
        variable = DeviceVariable(
            ...
            attributes={
                "Actual": VariableAttribute(
                    type=var_type, mutability=mutability, persistent=True, constant=False
                )
            },
        )
    ...
    async def initialize_complete_device_model(
    ...
    async def _initialize_charging_station_component(
        self, station_id: str, station_info: Dict[str, Any]
    ) -> None:
        """Initialize ChargingStation component."""
        ...
        await self._set_variable_value(
            ...
            "",
            AttributeEnumType.actual,
            station_info.get("vendor_name", "Unknown"),
        )
        await self._set_variable_value(
            station_id,
            "ChargingStation",
            ...
            "",
            AttributeEnumType.actual,
            station_info.get("model", "Unknown"),
        )
        await self._set_variable_value(
            station_id,
            "ChargingStation",
            ...
            "",
            AttributeEnumType.actual,
            station_info.get("serial_number", "Unknown"),
        )
        await self._set_variable_value(
            station_id,
            "ChargingStation",
            ...
            "",
            AttributeEnumType.actual,
            station_info.get("firmware_version", "1.0.0"),
        )
        await self._set_variable_value(
            station_id,
            "ChargingStation",
            ...
            "",
            AttributeEnumType.actual,
            "Core,SmartCharging,RemoteTrigger,Reservation,LocalAuthListManagement,SoC,RemoteControl,DisplayMessages,ISO15118Pnc,ISO15118Common,DeviceData,Monitoring,LocalListManagement,ExtendedTriggerMessage,ISO15118PnC,ISO15118Common,DeviceData,Monitoring,LocalListManagement,ExtendedTriggerMessage",
        )
        await self._set_variable_value(
            station_id,
            "ChargingStation",
    ...
    async def _initialize_evse_components(
        self, station_id: str, station_info: Dict[str, Any]
    ) -> None:
        """Initialize EVSE components."""
        ...
        for evse_id in range(1, num_evses + 1):
            ...
            await self._set_variable_value(
                station_id, "EVSE", str(evse_id), "Enabled", "", AttributeEnumType.actual, "true"
            )
            await self._set_variable_value(
                station_id,
                "EVSE",
                ...
                "",
                AttributeEnumType.actual,
                str(station_info.get("max_power", 22.0)),
            )
            await self._set_variable_value(
                station_id,
                "EVSE",
                ...
                "",
                AttributeEnumType.actual,
                str(station_info.get("v2x_capable", False)).lower(),
            )

    async def _initialize_connector_components(
        self, station_id: str, station_info: Dict[str, Any]
    ) -> None:
        """Initialize Connector components."""
        ...
        for connector_id in range(1, num_connectors + 1):
            ...
            await self._set_variable_value(
                ...
                "",
                AttributeEnumType.actual,
                station_info.get("connector_type", "cType2"),
            )
            await self._set_variable_value(
                station_id,
                "Connector",
            ...
            await self._set_variable_value(
                ...
                "",
                AttributeEnumType.actual,
                str(station_info.get("max_voltage", 400)),
            )
            await self._set_variable_value(
                station_id,
                "Connector",
                ...
                "",
                AttributeEnumType.actual,
                str(station_info.get("max_amperage", 32)),
            )
            await self._set_variable_value(
                station_id,
                "Connector",
                ...
                "",
                AttributeEnumType.actual,
                str(station_info.get("max_power", 22000)),
            )
    ...
    async def _initialize_frequency_simulator_component(
    ...
    async def _initialize_security_component(self, station_id: str) -> None:
        ...
        security_variables = [
            ...
            },
            {
                "name": "TlsCipherSuite",
                "type": VariableType.STRING.value,
                "default_value": "TLS_AES_256_GCM_SHA384",
            },
        ]
    ...
    async def _initialize_iso15118_ctrlr_component(self, station_id: str) -> None:
        ...
        iso15118_variables = [
            ...
            },
            {
                ...
                "type": VariableType.STRING.value,
                "default_value": "PnC,ContractCertificate,Payment",
            },
            {
                "name": "SupportedPaymentMethods",
                "type": VariableType.STRING.value,
                "default_value": "Contract,ExternalPayment",
            },
            {
                "name": "MaxContractIdLength",
                "type": VariableType.INTEGER.value,
                "default_value": "36",
            },
            {
            ...
            {
                "name": "CertificateInstallationTimeout",
                "type": VariableType.INTEGER.value,
                "default_value": "300",
            },
            {
                "name": "CertificateUpdateTimeout",
                "type": VariableType.INTEGER.value,
                "default_value": "60",
            },
        ]
    ...
    async def _initialize_display_component(self, station_id: str) -> None:
        ...
        display_variables = [
            {
                "name": "SupportedDisplayMessageTypes",
                "type": VariableType.STRING.value,
                "default_value": "Normal,Info,Warning,Error",
            },
            {
                "name": "SupportedLanguages",
                "type": VariableType.STRING.value,
                "default_value": "en,de,fr,es",
            },
            {
                "name": "MaxDisplayMessageLength",
                "type": VariableType.INTEGER.value,
                "default_value": "160",
            },
        ...
        meter_variables = [
            {
                "name": "MeterType",
                "type": VariableType.STRING.value,
                "default_value": "EnergyMeter",
            },
            {
                "name": "MeterSerialNumber",
                "type": VariableType.STRING.value,
                "default_value": "METER001",
            },
            {
        ...
        network_variables = [
            {
                ...
                "type": VariableType.STRING.value,
                "default_value": "Ethernet,WiFi,4G",
            },
            {
                "name": "NetworkSecurity",
                "type": VariableType.STRING.value,
                "default_value": "WPA2,TLS",
            },
    ...
    async def _initialize_firmware_component(self, station_id: str) -> None:
        ...
        firmware_variables = [
            ...
            {
                "name": "FirmwareUpdateRetryCount",
                "type": VariableType.INTEGER.value,
                "default_value": "3",
            },
            {
                "name": "FirmwareUpdateTimeout",
                "type": VariableType.INTEGER.value,
                "default_value": "3600",
            },
        ]
    ...
    async def get_variables(
        self, station_id: str, get_variable_data: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
    ...
    async def set_variables(
        self, station_id: str, set_variable_data: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
    ...
    async def _set_variable_value(
        ...
        try:
            ...
            return {"status": "Accepted", "reason_code": None, "additional_info": None}

        except Exception as e:
            self.logger.error(f"Error setting variable {variable_name}: {e}")
            return {"status": "Rejected", "reason_code": "InternalError", "additional_info": str(e)}
    ...
    async def get_base_report(self, station_id: str, report_base: str) -> Dict[str, Any]:
        ...
        try:
            ...
            report_data = {"reportBase": report_base, "reportData": []}
                    ...
                    if variable["component_name"] == component["name"]:
                        ...
                        if variable.get("actual_value") is not None:
                            var_data["variableAttribute"] = [
                                {"type": "Actual", "value": variable["actual_value"]}
                            ]
            ...
            return {"reportBase": report_base, "reportData": []}
    ...
    async def initialize_station_device_model(
        self, station_id: str, station_info: Dict[str, Any]
    ) -> None:
        ...
        try:
            ...
            initial_variables = {
                ...
                "Security": {"SecurityProfile": 1, "CertificateStoreMaxLength": 20},
                "V2XController": {"Enabled": True, "SupportedOperationModes": "CentralSetpoint"},
                "Monitoring": {"HeartbeatInterval": 300, "ClockAlignedDataInterval": 900},
            }
