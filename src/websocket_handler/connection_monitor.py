...
class ConnectionMonitor:
    ...
    async def _check_timescale_connection(self, current_time: datetime) -> None:
        ...
        try:
            ...
            if is_healthy:
                ...
                self.logger.warning(f"TimescaleDB health check failed (failure #{self.connection_failures['timescale']})")
    ...
    async def _check_supabase_connection(self, current_time: datetime) -> None:
        ...
        try:
            ...
            if is_healthy:
                ...
                self.logger.warning(f"Supabase health check failed (failure #{self.connection_failures['supabase']})")
    ...
    def get_connection_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_health_check': {
                'timescale': self.last_health_check['timescale'].isoformat() if self.last_health_check['timescale'] else None,
                'supabase': self.last_health_check['supabase'].isoformat() if self.last_health_check['supabase'] else None,
            },
