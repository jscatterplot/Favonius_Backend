...
- Departure SoC fields: ``departure_soc``, ``target_soc``,
  ``required_soc``, ``soc_at_departure``. Values in ``[0, 1]`` are
  treated as fractions; values ``> 1`` are treated as percent and
  divided by 100. This forgives both conventions in workflow drafts.
